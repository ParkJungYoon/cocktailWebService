...
const checkState = {
  ...
  typeImgs: {
    ISTJ: Mojito, // Faust
    ISTP: Mojito, // Cosmopolitan
    ISFJ: Mojito, // PinkLady
    ISFP: Mojito, // Mojito
    INTJ: Mojito, // Faust
    INTP: Mojito, // Cosmopolitan
    INFJ: Mojito, // PinkLady
    INFP: Mojito, // KahluaMilk
    ESTJ: Mojito, // B-52
    ESTP: Mojito, // JackCoke
    ESFJ: Mojito, // PeachCrush
    ESFP: Mojito, // JackCoke
    ENTJ: Mojito, // B-52
    ENTP: Mojito, // Screwdriver
    ENFJ: Mojito, // PeachCrush
    ENFP: Mojito, // Screwdriver
  },
  typeInfos: {
    ISTJ: [
    ...
    ISFP: [
      ...
      <br />,
      "Mojito는 럼 피즈에 민트를 첨가해 시원한 청량감과 산뜻한 맛을 냅니다.",
      <br />,
      "맛은 달달함과 동시에 민트 향을 내면서 씁쓸한 뒷맛이 스쳐가는 매력적인 칵테일 입니다.",
    ],
    INTJ: [
      "파우스트처럼 핏빛보다 진하지만 어둡지 않은 진홍빛을 가지고 있는 당신, 내적인 힘이 강인한 사람이군요.",
      <br />,
    ...
    INFP: [
      ...
      <br />,
      "남들은 본인에게 착하다고하지만 정작 본인은 그렇게 생각하지않아요.",
      <br />,
      " 사실 착하다고하면 부담스러워요 ㅠㅠ",
      <br />,
      "갈등상황을 싫어하는 타입이라 대부분 상대방의 의견에 따르는 편이에요.",
      <br />,
      "누가 나에게 부탁하는건 잘 들어주지만 남한테 민폐끼치는것을 싫어해",
      <br />,
      " 상대방에게 부탁하는 것은 어려워해요.",
      <br />,
