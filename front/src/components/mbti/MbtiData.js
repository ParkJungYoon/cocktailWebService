const state = {
  questions: {
    1: {
      1: "낮선 사람과 술자리를 갖게 되었습니다. 당신의 행동은?",
    },
    2: {
      1: "오늘은 불금, 술을 마시고 싶던 당신은 친구들에게 전화하지만 아무도 받지 않는다...",
    },
    3: {
      1: "평소 술을 좋아하는 당신, 자신이 좋아하는 술을 친구들에게 소개한다면??",
    },
    4: {
      1: "술자리가 마무리 되어가던 중",
      2: "그럼 N차 장소는 어디야? 분위기 쭉쭉 이어가야지~",
      3: "라는 말이 나왔다. 당신의 행동은???",
    },
    ...
    6: {
      1: "오랜만에 칵테일 바에 방문한 당신은 바텐더에 다가가 칵테일을 주문하려고 한다.",
    },
    7: {
      1: "냉장고에 남은 술로 칵테일을 만들기로 한 당신",
    },
    8: {
      1: "홈 칵테일을 만들기 위해 이것저것 준비하던 중 미리 구매했던 지거(계량기)가 사라졌다..",
    },
    9: {
      1: "연인과 함께 칵테일 바에 놀러간 당신 앞에서 화려한 묘기로 칵테일을 섞는 바텐더를 보고 든 생각은?",
    },
    ...
    11: {
      1: "~~~해서 진짜 짜증났다니까...... 듣고 있어??",
      2: "연인과 술을 마시던 중 잠깐 딴생각해 대화에 집중하지 못한 당신.",
    },
    12: {
      1: "친구에게 집에서 직접 칵테일을 만들어 먹었다고 연락이 왔다.",
    },
    13: {
      1: "친구가 나름 심혈을 기울여 만든 칵테일을 맛본 당신",
      2: "생각보다 맛있어 한마디 하게 되는데?",
    },
    ...
    17: {
      1: "당신의 눈동자에 건배...",
      2: "조용히 바에서 혼자 술을 마시던 당신은 누군가가 미리 계산한 칵테일을 건내받게 되었습니다.",
    },
    18: {
      1: "퇴근하던 중 허름한 골목을 지나가게 된 당신",
      2: "우연히 작고 분위기좋은 칵테일 바를 보게 되었습니다.",
    },
    19: { 1: "평소 썸을 타던 상대방과 함께 술을 마시게 된 당신" },
