const state = {
  questions: {
    ...
    2: [
      "오늘은 불금, 술을 마시고 싶던 당신은 친구들에게 전화하지만 아무도 받지 않는다...",
    ],
    3: [
      "평소 술을 좋아하는 당신, 자신이 좋아하는 술을 친구들에게 소개한다면??",
    ],
    4: [
      "술자리가 마무리 되어가던 중",
      <br />,
    ...
    5: [
      "오랜만에 칵테일 바에 방문한 당신은 바텐더에 다가가 칵테일을 주문하려고 한다.",
    ],
    6: ["냉장고에 남은 술로 칵테일을 만들기로 한 당신"],
    7: [
      "홈 칵테일을 만들기 위해 이것저것 준비하던 중 미리 구매했던 지거(계량기)가 사라졌다..",
    ],
    8: [
      "연인과 함께 칵테일 바에 놀러간 당신 앞에서 화려한 묘기로 칵테일을 섞는 바텐더를 보고 든 생각은?",
    ],
    ...
    10: ["친구에게 집에서 직접 칵테일을 만들어 먹었다고 연락이 왔다."],
    11: [
      "친구가 나름 심혈을 기울여 만든 칵테일을 맛본 당신",
      <br />,
      "생각보다 맛있어 한마디 하게 되는데?",
    ],
    ...
    14: [
      "퇴근하던 중 허름한 골목을 지나가게 된 당신",
      <br />,
      "우연히 작고 분위기좋은 칵테일 바를 보게 되었습니다.",
    ],
    15: ["평소 썸을 타던 상대방과 함께 술을 마시게 된 당신"],
  },
  answers: {
    //  E : correct answer
    1: {
