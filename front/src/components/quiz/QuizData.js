...
const state = {
  questions: {
    ...
    2: "Q2. 다음 기구의 이름은?",
    3: "Q3. 다음 설명으로 틀린 것은?",
    4: "Q9. 다음 중 국제 바텐더 협회의 약칭은?",
    5: "Q6. 다음 이미지는 칵테일 조주에 있어 술이나 부재료, 주스의 용량을 재는 기구로 이름은 무엇인가?",
    6: "Q5. 칵테일 용어 설명 중 틀린 것은?",
    7: "Q7.「Cocktail Glass」의 3대 명칭이 아닌 것은?",
    8: "Q8. 쿠바의 전통적인 음료 가운데 하나인 이 칵테일의 이름은?",
    9: "Q4. 다음 중 뜨거운 칵테일은 어떤 것인가?",
    10: "Q10. 아직 준비 중 입니다.",
  },
  answers: {
    1: {
